...
function callAppMenu() {
    var appMenu = [
        ["appmenuitemid1", "Item 1", "option1.png",
            null, {
                selectedImage: ""
            }
        ],
        ["appmenuitemid2", "Item 2", "option2.png",
            null, {
                selectedImage: ""
            }
        ],
        ["appmenuitemid3", "Item 3", "option3.png",
            null, {
                selectedImage: ""
            }
        ],
        ["appmenuitemid4", "Item 4", "option4.png",
            null, {
                selectedImage: ""
            }
        ]
    ];
    kony.application.createAppMenu("Project0db97a9c6AppMenu", appMenu, null, null);
    kony.application.setCurrentAppMenu("Project0db97a9c6AppMenu");
}